...
export const modules: ModuleConfig[] = [
 ...
 {key:'order',title:'订单管理',path:'/finance/order',icon:'shopping-cart',fetch:'/order/fetch',save:'/order/update',drop:'/order/cancel',fetchMethod:'ANY'},
 {key:'coupon',title:'优惠券管理',path:'/finance/coupon',icon:'ticket',fetch:'/coupon/fetch',save:'/coupon/update',drop:'/coupon/drop',fetchMethod:'ANY'},
