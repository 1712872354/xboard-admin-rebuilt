...
export const adminNavigation: NavItem[] = [
  ...
  { key:'group', label:'分组管理', path:'/server/group', icon:'layers-3' },
  ...
  { key:'gift-card', label:'礼品卡管理', path:'/gift-card', icon:'credit-card' },
  { key:'user', label:'用户管理', path:'/user', icon:'users' },
  { key:'ticket', label:'工单管理', path:'/ticket', icon:'messages-square' },
  { key:'theme', label:'主题管理', path:'/theme', icon:'palette' },
